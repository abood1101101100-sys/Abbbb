...
@app.on_message(filters.command("blacklist_chat", prefixes="/!") & SUDOERS)
@capture_err
...
@app.on_message(filters.command("whitelist_chat", prefixes="/!") & SUDOERS)
@capture_err
...
@app.on_message(filters.command("blacklisted_chats", prefixes="/!") & SUDOERS)
@capture_err
